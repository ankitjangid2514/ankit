                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header p-t-15 p-b-15">
                                    ...
                                    <h5>galidesawar Winning Report</h5>

                                </div>

                                <div class="card-body">

                                    <form class="theme-form mega-form" id="galidesawarWinningReportFrm" name="galidesawarWinningReportFrm" method="post">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var table = $('#resultHistory').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route('desawar_winning_report_list') }}',
                        type: 'get',
                        data: function(d) {
