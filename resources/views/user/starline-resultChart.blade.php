...
<html>
<head>
	<title>Starline Result Chart</title>
	<meta charset="UTF-8">
	...
	<section class="dashCard1" style="margin-top:5px;">
		...
		<div class="row">
			<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xlg-12">
				<h3 class="resultHeading"><span>Starline
                    @foreach ($star as $market)
                        {{$market->starline_name}}
                    @endforeach
							...
							<div class="card text-white bg-danger mb-3">
								<div class="row " style="display: flex;justify-content: center; margin-bottom: 10px;">
									...
									<div class="col-10">
										<div class="row ">
											<div class="col-12 ">
												<h4 class="card-title game">{{ substr($result->panna, 0, 1) }}</h4>
											</div>

											<div class="col-4">
												<h4 class="card-title game">{{ substr($result->panna, 1, 1) }}</h4>
											</div>
									...
									<div class="col-10">
										<div class="row ">
											<div class="col-12">
												<h4 class="card-title game">{{ substr($result->panna, 2, 1) }}</h4>
											</div>
