...
<div class="container-fluid">
	<div class="row" style="background: var(--primary);padding: 10px;">
		<div class="col-12">
			<span style="color:var(--white); font-family: auto;font-size: 18px;">Wallet History</span>
		</div>
	</div>
</div>
    ...
    <div class="row" style="border-bottom: 1px var(--primary) solid;">
			...
			<div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-11 col-xs-11 col-sm-11 col-md-11 col-lg-11 col-xlg-11">
                        <p class="game_name" style="margin-top: 8px;FONT-SIZE: 14px;font-family: system-ui;">Withdrawal - {{$bid->payout}}</p>
                        <p style="color: #89543c;font-size: 12px;margin-bottom: 9px;">{{$bid->withdrawal_date}}</p> 
                    </div>
                    <div class="col-1 col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xlg-1">	
                        <p style="float:right; margin-top:16px;" class="game_name">{{$bid->amount}}</p>
                    </div>
